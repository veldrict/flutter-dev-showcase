...
abstract class _NoData implements CommentsFailure {
...
class _$_NoInternet implements _NoInternet {
  ...
  @override
  String toString() {
    return 'CommentsFailure.noInternet()';
  }
...
abstract class _NoInternet implements CommentsFailure {
...
abstract class _Failed implements CommentsFailure {
